...
export default function DashboardPage() {
    ...
    useEffect(() => {
        async function fetchDashboardData() {
            try {
                // 1. Buscando Sacolas ABERTAS (O que está na rua)
          ...
          `)
                ...
                // 3. Buscando Histórico Recente (Últimas 5 fechadas)
                ...
                if (openConsignments) {
                    ...
                    // Preparando dados para o Gráfico (Quem está com mais valor?)
                    // Pegamos as sacolas abertas e formatamos para o gráfico
                    const chartDataRaw = openConsignments.map((c: any) => ({
                        name: c.resellers.name.split(' ')[0], // Pega só o primeiro nome
                        value: c.total_value
                    }))
    ...
    return (
        <div className="container mx-auto py-8 max-w-6xl space-y-8">
            ...
            <div className="grid gap-4 grid-cols-1 lg:grid-cols-7">
                ...
                {/* Gráfico: Ranking de Sacolas Abertas */}
                ...
                {/* Lista Lateral: Últimos Fechamentos */}
